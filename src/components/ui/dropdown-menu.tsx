...
const dropdownMenuItemVariants = cva(
    "group/menu-item relative flex cursor-pointer select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden focus:bg-accent focus:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 data-[slot=menu-indicator]:py-1 data-inset:pl-8 [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 [&_svg]:pointer-events-none",
    {
        variants: {
            variant: {
...
function DropdownMenuCheckboxItem({
    ...
    return (
        <DropdownMenuPrimitive.CheckboxItem
            ...
            className={cn(
                "group relative flex cursor-pointer select-none items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden focus:bg-accent focus:text-accent-foreground data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 [&_svg]:pointer-events-none",
                className,
            )}
            checked={checked}
            {...props}
        >
            <span className="pointer-events-none absolute left-2 flex size-3.5 items-center justify-center border border-border rounded-sm transition-all group-data-checked:bg-primary group-data-checked:text-primary-foreground group-data-checked:border-primary">
